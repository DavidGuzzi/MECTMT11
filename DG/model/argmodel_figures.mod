% =============================================================================
% ARGMODEL_FIGURES.MOD - Modelo para generar Figuras 1 y 2 (Argentina)
% Genera FEVD (Figura 1) e IRFs (Figura 2)
% =============================================================================
...
% =============================================================================
% ESTIMACION PARA FIGURAS (ARGENTINA)
% =============================================================================
% Usa mode_compute=0 para cargar el mode estimado previamente
% mh_replic=0: Solo usa el mode, sin MCMC

estimation(optim=('MaxIter',200),datafile=argmodel_data,mode_compute=0,mode_file=argmodel_mode,first_obs=1,presample=4,lik_init=2,prefilter=0,mh_replic=0,mh_nblocks=2,mh_jscale=0.20,mh_drop=0.2);

% Generate IRFs, Moments and Conditional Variance Decomposition for Figures 1 & 2
% Horizons 1-100 to match paper (1, 2, 4, 10, 40, 100)
stoch_simul(irf=20, conditional_variance_decomposition=[1:100]) dy pinfobs robs y lab labobs ;
